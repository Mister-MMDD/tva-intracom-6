...
COUNTRY_NAMES: Dict[str, str] = {
    ...
    "MR": "Mauritanie",
    "AD": "Andorre",     "LI": "Liechtenstein", "SM": "Saint-Marin",
    "RS": "Serbie",      "ME": "Monténégro", "BA": "Bosnie-Herzégovine",
    "AL": "Albanie",     "MK": "Macédoine du Nord",
    "AR": "Argentine",   "CL": "Chili",      "CO": "Colombie",
    "PE": "Pérou",       "LB": "Liban",      "JO": "Jordanie",
    "OM": "Oman",        "NG": "Nigéria",    "KE": "Kenya",
    "SN": "Sénégal",     "CI": "Côte d'Ivoire", "CM": "Cameroun",
    "GE": "Géorgie",     "AM": "Arménie",    "MD": "Moldavie",
    "AZ": "Azerbaïdjan", "BY": "Biélorussie", "KZ": "Kazakhstan",
    "UZ": "Ouzbékistan", "KG": "Kirghizistan", "TJ": "Tadjikistan",
    "TM": "Turkménistan", "BH": "Bahreïn",    "KH": "Cambodge",
    "LA": "Laos",        "MM": "Myanmar",    "PA": "Panama",
    "CR": "Costa Rica",  "DO": "République Dominicaine", "GH": "Ghana",
    "ET": "Éthiopie",    "TZ": "Tanzanie",   "MU": "Maurice",
...
COUNTRY_CURRENCIES: Dict[str, str] = {
    ...
    "RU": "RUB",
    "DZ": "DZD", "TN": "TND", "LY": "LYD", "MR": "MRU",
    "AD": "EUR", "LI": "CHF", "SM": "EUR", "RS": "RSD",
    "ME": "EUR", "BA": "BAM", "AL": "ALL", "MK": "MKD",
    "AR": "ARS", "CL": "CLP", "CO": "COP", "PE": "PEN",
    "LB": "LBP", "JO": "JOD", "OM": "OMR", "NG": "NGN",
    "KE": "KES", "SN": "XOF", "CI": "XOF", "CM": "XAF",
    "GE": "GEL", "AM": "AMD", "MD": "MDL",
    "AZ": "AZN", "BY": "BYN", "KZ": "KZT", "UZ": "UZS",
    "KG": "KGS", "TJ": "TJS", "TM": "TMT", "BH": "BHD",
    "KH": "KHR", "LA": "LAK", "MM": "MMK", "PA": "PAB",
    "CR": "CRC", "DO": "DOP", "GH": "GHS", "ET": "ETB",
    "TZ": "TZS", "MU": "MUR",
}
...
CURRENCY_SYMBOLS: Dict[str, str] = {
    ...
    "EGP": "E£",
    "RUB": "₽",
    "DZD": "DA", "TND": "DT", "LYD": "LD", "MRU": "UM",
    "RSD": "din.", "BAM": "KM", "ALL": "L", "MKD": "den",
    "ARS": "$", "CLP": "$", "COP": "$", "PEN": "S/",
    "LBP": "L£", "JOD": "JD", "OMR": "RO", "NGN": "₦",
    "KES": "KSh", "XOF": "CFA", "XAF": "CFA", "GEL": "₾",
    "AMD": "֏", "MDL": "L",
    "AZN": "₼", "BYN": "Br", "KZT": "₸", "UZS": "soʻm",
    "KGS": "с", "TJS": "SM", "TMT": "T", "BHD": "BD",
    "KHR": "៛", "LAK": "₭", "MMK": "K", "PAB": "B/.",
    "CRC": "₡", "DOP": "RD$", "GHS": "GH₵", "ETB": "Br",
    "TZS": "TSh", "MUR": "₨",
}
